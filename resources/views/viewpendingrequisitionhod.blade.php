...
<form action="/updaterequisitionhodapprove/{{$requisitionheader->id}}" method="post">
  {{csrf_field()}}
<div class="table-responsive">
	<table class="table table-responsive table-hover table-bordered table-striped">
...
<table class="table table-responsive">
	<tr>
		<td ><button type="submit" class="btn btn-success pull-right" onclick="return confirm('Do You Want to Proceed?')">APPROVE (HOD)</button></td>
	</tr>
  <tr>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/changependingstatustocanceledhod/{{$requisitionheader->id}}" method="post">
            {{csrf_field()}}
          <table class="table">
