...
<table class="table">
	<tr class="bg-navy">
		<td class="text-center">VIEW PENDING USER ASSIGNED TENDER</td>
...
<table class="table">
	<tr>
	   ...
	   <td><strong>Write a Remark</strong></td>
	   <td><textarea class="form-control" id="remarks"></textarea></td>
	   <td><button type="button" onclick="saveadminremarks();" class="btn btn-success">SAVE</button></td>
	</tr>
