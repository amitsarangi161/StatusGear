...
<table class="table table-responsive table-hover table-bordered table-striped datatablescroll">
	...
	<tbody>
		@foreach($tenders as $tender)
		   ...
		   <tr>
		   	<td><a href="/viewassignedtenderoffice/{{$tender->id}}" class="btn btn-info">{{$tender->id}}</a></td>
        ...
        <td>{{$tender->name}}</td>
		   	<td><a href="/viewassignedtenderoffice/{{$tender->id}}" class="btn btn-info">VIEW</a></td>
