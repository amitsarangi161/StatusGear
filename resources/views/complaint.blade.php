...
<style type="text/css">
 ...
 @if(Session::has('message'))
   ...
   @endif
<form action="/savecomplaint" enctype="multipart/form-data" method="post">
  {{csrf_field()}}
...
<table class="table table-responsive table-hover table-bordered table-striped">
  ...
  <tr>
    ...
    <td><input type="text" autocomplete="off" name="date" class="form-control datepicker2 readonly" required></td>
  </tr>
  <tr>
 ...
 <table class="table">
      ...
      @if($filterreq)
    <tr>
      <td ><a href="/uc/complaint" class="btn btn-danger">Clear Search</a></td>
