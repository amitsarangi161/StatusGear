...
<table class="table table-responsive table-hover table-bordered table-striped">
  ...
  <tr>
    <td colspan="4" style="text-align: right;"><button type="submit" class="btn btn-success">Submit</button></td>
  </tr>
</table>
</form>
...
<table class="table">
      @if($filterreq)
    <tr>
      <td ><a href="/ucacc/complaint" class="btn btn-danger">Clear Search</a></td>
    ...
    <tr>
      ...
      <a href="/ucacc/complaint" class="btn btn-info btn-lg">CREATE A COMPALINT</a>
      </td>
    </tr>
...
<table class="table table-responsive table-hover table-bordered table-striped datatable1" style="width:100%;">
  ...
  <tbody>
    ...
    <tr style="background-color: {{$col}};font-size: 12px;">
      ...
      @endif
       <td>
         <a href="/viewcomplaintdetailsaccount/{{$compalint->id}}" class="btn btn-success">VIEW</a>
       </td>
