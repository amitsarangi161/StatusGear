...
<table class="table table-responsive table-hover table-bordered table-striped datatable" style="width: 100%;">
	...
	<tbody>
		@foreach($debitvouchers as $debitvoucher)
          <tr>
          	<td><a href="/viewpendinfdebitvouchermgr/{{$debitvoucher->id}}" target="_blank" class="btn btn-primary">{{$debitvoucher->id}}</a></td>
          	...
          	<td><a href="/viewpendinfdebitvouchermgr/{{$debitvoucher->id}}" target="_blank" class="btn btn-primary">View</a></td>
          </tr>
