...
<table class="table">
   ...
   @endif
	...
	<tr>
		...
		<td>
			<input type="text" autocomplete="off" placeholder="Eg:OR02BR1669" class="form-control" name="vehicleno" required="">
		</td>
	...
	<tr>
		...
		<td>
			<input type="text" autocomplete="off" placeholder="Enter Driver name" class="form-control" name="drivername" required="">
		</td>
	...
	<tr>
		...
		<td>
			<input type="number" autocomplete="off" placeholder="Enter Driver Mobile" class="form-control" name="drivermobile" required="">
		</td>
	...
	<tr>
		...
		<td>
			 <input type="file" name="rcimage" onchange="readURL(this);" required="">
		</td>
...
<table class="table table-responsive table-hover table-bordered table-striped datatable">
	...
	<tbody>
		...
		<tr>
		 ...
		 <td><img style="height:70px;width:95px;" alt="no uploadedfile" src="{{ asset('/img/vehicle/'.$vehicle->vehicleimage )}}"></td>
		 <td><img style="height:70px;width:95px;" alt="no uploadedfile" src="{{ asset('/img/vehicle/'.$vehicle->rcimage )}}"></td>
