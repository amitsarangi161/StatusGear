...
<table class="table table-responsive table-hover table-bordered table-striped datatable">
   ...
   <tr>
     <td><strong>REQUEST TO DIFFER DATE</strong></td>
     <td><input type="text" autocomplete="off" placeholder="Enter Differ date Here" name="lastdate" class="form-control datepicker2 readonly" autocomplete="off" required=""></td>
   </tr>
   <tr>
